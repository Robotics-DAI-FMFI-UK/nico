...
int DXL_INIT_VALUE[] = { 0, 0, 0, 0, 0, 0, 0, 0, 577, 1188, 4068, 10, 2007, 1972, 2076, 1917, 1957, 2038, 946, 2947, 2377, 1982 };               
...
void nico_set_wished_motor_positions(motor_data *new_motor_data)
{
	printf("previous:  ");
	for (int i = 0; i < DEMO_MOTORS; i++)
		printf("%4d ", wished_motor_positions[i]);
	printf("\nrequested: ");
	for (int i = 0; i < DEMO_MOTORS; i++)
		printf("%4hd ", new_motor_data->data[i]);
	printf("\n");

	for (int i = 0; i < DEMO_MOTORS; i++)
	    wished_motor_positions[i] = new_motor_data->data[i];
}
